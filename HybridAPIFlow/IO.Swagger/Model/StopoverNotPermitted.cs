...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StopoverNotPermitted : Stopover,  IEquatable<StopoverNotPermitted>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StopoverNotPermitted" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected StopoverNotPermitted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="StopoverNotPermitted" /> class.
        /// </summary>
        /// <param name="notPermittedInd">if true, stopovers are not permitted.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public StopoverNotPermitted(bool? notPermittedInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "StopoverNotPermitted", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
        ...
        /// </summary>
        /// <value>if true, stopovers are not permitted</value>
        ...
        {
            return this.Equals(input as StopoverNotPermitted);
        }

        /// <summary>
        /// Returns true if StopoverNotPermitted instances are equal
        /// </summary>
        /// <param name="input">Instance of StopoverNotPermitted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StopoverNotPermitted input)
        {
            if (input == null)
                return false;
