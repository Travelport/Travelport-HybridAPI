...
{
    /// <summary>
    /// CatalogProductOfferingSummary
    /// </summary>
    [DataContract]
    public partial class CatalogProductOfferingSummary : CatalogProductOfferingID,  IEquatable<CatalogProductOfferingSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOfferingSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CatalogProductOfferingSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOfferingSummary" /> class.
        /// </summary>
        ...
        public CatalogProductOfferingSummary(int? sequence = default(int?), string departure = default(string), string arrival = default(string), List<BrandID> brand = default(List<BrandID>), List<ProductBrandOptions> productBrandOptions = default(List<ProductBrandOptions>), Object extensionPoint = default(Object), string type = "CatalogProductOfferingSummary", string id = default(string), Identifier identifier = default(Identifier), string catalogProductOfferingRef = default(string)) : base(type, id, identifier, catalogProductOfferingRef)
        {
            // to ensure "productBrandOptions" is required (not null)
            if (productBrandOptions == null)
            {
                throw new InvalidDataException("productBrandOptions is a required property for CatalogProductOfferingSummary and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CatalogProductOfferingSummary {\n");
        ...
        {
            return this.Equals(input as CatalogProductOfferingSummary);
        }

        /// <summary>
        /// Returns true if CatalogProductOfferingSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogProductOfferingSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogProductOfferingSummary input)
        {
            if (input == null)
                return false;
