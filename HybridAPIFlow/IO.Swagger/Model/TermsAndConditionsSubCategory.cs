...
namespace IO.Swagger.Model
{
    ...
    public partial class TermsAndConditionsSubCategory :  IEquatable<TermsAndConditionsSubCategory>, IValidatableObject
    {
        ...
        public TermsAndConditionsSubCategory(string type = default(string), string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
