...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CatalogProductOffering : CatalogProductOfferingID,  IEquatable<CatalogProductOffering>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOffering" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CatalogProductOffering() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOffering" /> class.
        /// </summary>
        ...
        public CatalogProductOffering(int? sequence = default(int?), string departure = default(string), string arrival = default(string), List<BrandID> brand = default(List<BrandID>), List<ProductBrandOptions> productBrandOptions = default(List<ProductBrandOptions>), Object extensionPoint = default(Object), string type = "CatalogProductOffering", string id = default(string), Identifier identifier = default(Identifier), string catalogProductOfferingRef = default(string)) : base(type, id, identifier, catalogProductOfferingRef)
        {
            // to ensure "productBrandOptions" is required (not null)
            if (productBrandOptions == null)
            {
                throw new InvalidDataException("productBrandOptions is a required property for CatalogProductOffering and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CatalogProductOffering {\n");
        ...
        {
            return this.Equals(input as CatalogProductOffering);
        }

        /// <summary>
        /// Returns true if CatalogProductOffering instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogProductOffering to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogProductOffering input)
        {
            if (input == null)
                return false;
