...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ArrivalFlightSummary : ArrivalFlightID,  IEquatable<ArrivalFlightSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrivalFlightSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ArrivalFlightSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrivalFlightSummary" /> class.
        /// </summary>
        ...
        public ArrivalFlightSummary(int? distance = default(int?), int? stops = default(int?), string duration = default(string), string carrier = default(string), string number = default(string), string operatingCarrier = default(string), string operatingCarrierName = default(string), string equipment = default(string), Departure departure = default(Departure), Arrival arrival = default(Arrival), List<IntermediateStop> intermediateStop = default(List<IntermediateStop>), bool? subjectToGovernmentApprovalInd = default(bool?), Object extensionPoint = default(Object), string type = "ArrivalFlightSummary", string id = default(string), string flightRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, flightRef, identifier)
        {
            // to ensure "carrier" is required (not null)
            if (carrier == null)
            {
                throw new InvalidDataException("carrier is a required property for ArrivalFlightSummary and cannot be null");
            }
            else
            {
            ...
            if (number == null)
            {
                throw new InvalidDataException("number is a required property for ArrivalFlightSummary and cannot be null");
            }
            else
            {
                this.Number = number;
            ...
            if (departure == null)
            {
                throw new InvalidDataException("departure is a required property for ArrivalFlightSummary and cannot be null");
            }
            else
            {
            ...
            if (arrival == null)
            {
                throw new InvalidDataException("arrival is a required property for ArrivalFlightSummary and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ArrivalFlightSummary);
        }

        /// <summary>
        /// Returns true if ArrivalFlightSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ArrivalFlightSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArrivalFlightSummary input)
        {
            if (input == null)
                return false;
