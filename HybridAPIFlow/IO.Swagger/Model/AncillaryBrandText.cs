...
namespace IO.Swagger.Model
{
    ...
    public partial class AncillaryBrandText :  IEquatable<AncillaryBrandText>, IValidatableObject
    {
        ...
        public AncillaryBrandText(string type = default(string), string id = default(string), BrandTargetEnum? target = default(BrandTargetEnum?), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
