...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifyPriceDetail : ModifyPrice,  IEquatable<ModifyPriceDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyPriceDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifyPriceDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyPriceDetail" /> class.
        /// </summary>
        /// <param name="priceBreakdown">priceBreakdown.</param>
        /// <param name="extensionPointDetail">extensionPointDetail.</param>
        public ModifyPriceDetail(List<PriceBreakdown> priceBreakdown = default(List<PriceBreakdown>), ExtensionPointDetail extensionPointDetail = default(ExtensionPointDetail), string type = "ModifyPriceDetail", string id = default(string), CurrencyCode currencyCode = default(CurrencyCode), float? _base = default(float?), float? totalTaxes = default(float?), float? totalFees = default(float?), float? totalPrice = default(float?), VendorCurrencyTotal vendorCurrencyTotal = default(VendorCurrencyTotal), Object extensionPoint = default(Object)) : base(type, id, currencyCode, _base, totalTaxes, totalFees, totalPrice, vendorCurrencyTotal, extensionPoint)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyPriceDetail {\n");
        ...
        {
            return this.Equals(input as ModifyPriceDetail);
        }

        /// <summary>
        /// Returns true if ModifyPriceDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyPriceDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyPriceDetail input)
        {
            if (input == null)
                return false;
