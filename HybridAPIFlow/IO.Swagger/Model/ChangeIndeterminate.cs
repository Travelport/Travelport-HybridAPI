...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangeIndeterminate : Change,  IEquatable<ChangeIndeterminate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeIndeterminate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangeIndeterminate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeIndeterminate" /> class.
        /// </summary>
        ...
        public ChangeIndeterminate(bool? indeterminateInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "ChangeIndeterminate", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
        ...
        {
            return this.Equals(input as ChangeIndeterminate);
        }

        /// <summary>
        /// Returns true if ChangeIndeterminate instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeIndeterminate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeIndeterminate input)
        {
            if (input == null)
                return false;
