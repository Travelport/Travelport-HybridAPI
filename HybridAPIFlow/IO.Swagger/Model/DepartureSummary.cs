...
namespace IO.Swagger.Model
{
    ...
    public partial class DepartureSummary :  IEquatable<DepartureSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartureSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepartureSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartureSummary" /> class.
        /// </summary>
        ...
        public DepartureSummary(string type = default(string), string location = default(string), DateTime? date = default(DateTime?), string time = default(string), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DepartureSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for DepartureSummary and cannot be null");
            }
            else
            {
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for DepartureSummary and cannot be null");
            }
            else
            {
                this.Date = date;
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for DepartureSummary and cannot be null");
            }
            else
            {
                this.Time = time;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DepartureSummary {\n");
        ...
        {
            return this.Equals(input as DepartureSummary);
        }

        /// <summary>
        /// Returns true if DepartureSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of DepartureSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartureSummary input)
        {
            if (input == null)
                return false;
