...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpsellOffering : UpsellOfferingID,  IEquatable<UpsellOffering>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsellOffering" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpsellOffering() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsellOffering" /> class.
        /// </summary>
        ...
        public UpsellOffering(int? sequence = default(int?), List<string> productRefs = default(List<string>), string departure = default(string), string arrival = default(string), List<BrandID> brand = default(List<BrandID>), List<ProductBrandOptions> productBrandOptions = default(List<ProductBrandOptions>), Object extensionPoint = default(Object), string type = "UpsellOffering", string id = default(string), Identifier identifier = default(Identifier), string catalogProductOfferingRef = default(string)) : base(type, id, identifier, catalogProductOfferingRef)
        {
            // to ensure "productBrandOptions" is required (not null)
            if (productBrandOptions == null)
            {
                throw new InvalidDataException("productBrandOptions is a required property for UpsellOffering and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpsellOffering {\n");
        ...
        {
            return this.Equals(input as UpsellOffering);
        }

        /// <summary>
        /// Returns true if UpsellOffering instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsellOffering to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsellOffering input)
        {
            if (input == null)
                return false;
