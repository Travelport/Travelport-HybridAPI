...
namespace IO.Swagger.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(UpsellOffering), "UpsellOffering")]
    [JsonSubtypes.KnownSubType(typeof(UpsellOfferingSummary), "UpsellOfferingSummary")]
    public partial class UpsellOfferingID :  IEquatable<UpsellOfferingID>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsellOfferingID" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpsellOfferingID() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsellOfferingID" /> class.
        /// </summary>
        ...
        public UpsellOfferingID(string type = default(string), string id = default(string), Identifier identifier = default(Identifier), string catalogProductOfferingRef = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for UpsellOfferingID and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpsellOfferingID {\n");
        ...
        {
            return this.Equals(input as UpsellOfferingID);
        }

        /// <summary>
        /// Returns true if UpsellOfferingID instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsellOfferingID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsellOfferingID input)
        {
            if (input == null)
                return false;
