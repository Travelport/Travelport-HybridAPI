...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvanceReservationIndeterminate : AdvanceReservation,  IEquatable<AdvanceReservationIndeterminate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvanceReservationIndeterminate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvanceReservationIndeterminate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvanceReservationIndeterminate" /> class.
        /// </summary>
        /// <param name="indeterminateInd">If true the advance Reservation restrictions could not be determined.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public AdvanceReservationIndeterminate(bool? indeterminateInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "AdvanceReservationIndeterminate", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
        ...
        /// </summary>
        /// <value>If true the advance Reservation restrictions could not be determined</value>
        ...
        {
            return this.Equals(input as AdvanceReservationIndeterminate);
        }

        /// <summary>
        /// Returns true if AdvanceReservationIndeterminate instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvanceReservationIndeterminate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvanceReservationIndeterminate input)
        {
            if (input == null)
                return false;
