...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TermsAndConditionsFull : TermsAndConditionsFullID,  IEquatable<TermsAndConditionsFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsFull" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermsAndConditionsFull() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsFull" /> class.
        /// </summary>
        ...
        public TermsAndConditionsFull(DateTime? expiryDate = default(DateTime?), List<CustomerLoyalty> customerLoyalty = default(List<CustomerLoyalty>), List<TravelerProduct> travelerProduct = default(List<TravelerProduct>), List<TextBlock> textBlock = default(List<TextBlock>), Object extensionPoint = default(Object), string type = "TermsAndConditionsFull", string id = default(string), string termsAndConditionsRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, termsAndConditionsRef, identifier)
        {
        ...
        {
            return this.Equals(input as TermsAndConditionsFull);
        }

        /// <summary>
        /// Returns true if TermsAndConditionsFull instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsAndConditionsFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsAndConditionsFull input)
        {
            if (input == null)
                return false;
