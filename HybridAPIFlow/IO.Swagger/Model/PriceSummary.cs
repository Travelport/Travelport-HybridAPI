...
namespace IO.Swagger.Model
{
    ...
    public partial class PriceSummary :  IEquatable<PriceSummary>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceSummary(string type = default(string), string id = default(string), CurrencyCode currencyCode = default(CurrencyCode), float? _base = default(float?), float? totalTaxes = default(float?), float? totalFees = default(float?), float? totalPrice = default(float?), VendorCurrencyTotal vendorCurrencyTotal = default(VendorCurrencyTotal), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PriceSummary and cannot be null");
            }
            else
            {
                this.Type = type;
