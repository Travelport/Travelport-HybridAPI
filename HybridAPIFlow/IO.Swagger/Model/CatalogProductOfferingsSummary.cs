...
{
    /// <summary>
    /// CatalogProductOfferingsSummary
    /// </summary>
    [DataContract]
    public partial class CatalogProductOfferingsSummary : CatalogProductOfferingsID,  IEquatable<CatalogProductOfferingsSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOfferingsSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CatalogProductOfferingsSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOfferingsSummary" /> class.
        /// </summary>
        ...
        public CatalogProductOfferingsSummary(List<CatalogProductOfferingID> catalogProductOffering = default(List<CatalogProductOfferingID>), List<UpsellOfferingID> upsellOffering = default(List<UpsellOfferingID>), Object extensionPoint = default(Object), string type = "CatalogProductOfferingsSummary", string id = default(string), Identifier identifier = default(Identifier)) : base(type, id, identifier)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CatalogProductOfferingsSummary {\n");
        ...
        {
            return this.Equals(input as CatalogProductOfferingsSummary);
        }

        /// <summary>
        /// Returns true if CatalogProductOfferingsSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogProductOfferingsSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogProductOfferingsSummary input)
        {
            if (input == null)
                return false;
