...
namespace IO.Swagger.Model
{
    ...
    public partial class ProductOptionsIdentifier :  IEquatable<ProductOptionsIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductOptionsIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProductOptionsIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductOptionsIdentifier" /> class.
        /// </summary>
        ...
        public ProductOptionsIdentifier(string type = default(string), string id = default(string), Identifier identifier = default(Identifier), string productOptionsRef = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ProductOptionsIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as ProductOptionsIdentifier);
        }

        /// <summary>
        /// Returns true if ProductOptionsIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductOptionsIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductOptionsIdentifier input)
        {
            if (input == null)
                return false;
