...
namespace IO.Swagger.Model
{
    ...
    public partial class BrandTextSummary :  IEquatable<BrandTextSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandTextSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BrandTextSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandTextSummary" /> class.
        /// </summary>
        ...
        public BrandTextSummary(string type = default(string), string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BrandTextSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("textFormatted is a required property for BrandTextSummary and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BrandTextSummary);
        }

        /// <summary>
        /// Returns true if BrandTextSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandTextSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandTextSummary input)
        {
            if (input == null)
                return false;
