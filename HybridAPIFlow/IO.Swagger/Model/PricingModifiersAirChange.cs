...
namespace IO.Swagger.Model
{
    ...
    public partial class PricingModifiersAirChange :  IEquatable<PricingModifiersAirChange>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModifiersAirChange" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingModifiersAirChange() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModifiersAirChange" /> class.
        /// </summary>
        ...
        /// <param name="waiverCode">Assigned Type: ctar-1100:WaiverCode.</param>
        ...
        /// <param name="keepToBrandInd">If true, the offerings returned will be of the same brand as the original Offer.</param>
        /// <param name="extensionPoint">extensionPoint.</param>
        public PricingModifiersAirChange(string type = default(string), string currencyCode = default(string), FareSelection fareSelection = default(FareSelection), OrganizationInformation organizationInformation = default(OrganizationInformation), WaiverCode waiverCode = default(WaiverCode), TaxExemption taxExemption = default(TaxExemption), PromotionalCode promotionalCode = default(PromotionalCode), string sellCity = default(string), string ticketCity = default(string), bool? keepToBrandInd = default(bool?), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PricingModifiersAirChange and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// <summary>
        /// Assigned Type: ctar-1100:WaiverCode
        /// </summary>
        /// <value>Assigned Type: ctar-1100:WaiverCode</value>
        [DataMember(Name="WaiverCode", EmitDefaultValue=false)]
        public WaiverCode WaiverCode { get; set; }
        ...
        /// </summary>
        /// <value>If true, the offerings returned will be of the same brand as the original Offer</value>
        [DataMember(Name="keepToBrandInd", EmitDefaultValue=false)]
        public bool? KeepToBrandInd { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  WaiverCode: ").Append(WaiverCode).Append("\n");
            ...
            sb.Append("  KeepToBrandInd: ").Append(KeepToBrandInd).Append("\n");
        ...
        {
            return this.Equals(input as PricingModifiersAirChange);
        }

        /// <summary>
        /// Returns true if PricingModifiersAirChange instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingModifiersAirChange to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingModifiersAirChange input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WaiverCode == input.WaiverCode ||
                    (this.WaiverCode != null &&
                    this.WaiverCode.Equals(input.WaiverCode))
                ) && 
                (
                ...
                (
                    this.KeepToBrandInd == input.KeepToBrandInd ||
                    (this.KeepToBrandInd != null &&
                    this.KeepToBrandInd.Equals(input.KeepToBrandInd))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WaiverCode != null)
                    hashCode = hashCode * 59 + this.WaiverCode.GetHashCode();
                ...
                if (this.KeepToBrandInd != null)
                    hashCode = hashCode * 59 + this.KeepToBrandInd.GetHashCode();
