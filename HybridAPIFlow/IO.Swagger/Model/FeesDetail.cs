...
namespace IO.Swagger.Model
{
    ...
    public partial class FeesDetail : Fees,  IEquatable<FeesDetail>, IValidatableObject
    {
        ...
        public FeesDetail(List<Fee> fee = default(List<Fee>), ExtensionPointDetail extensionPointDetail = default(ExtensionPointDetail), string type = "FeesDetail", float? totalFees = default(float?), Object extensionPoint = default(Object)) : base(type, totalFees, extensionPoint)
        {
            this.Fee = fee;
