...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PenaltyPercent : Penalty,  IEquatable<PenaltyPercent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PenaltyPercent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PenaltyPercent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PenaltyPercent" /> class.
        /// </summary>
        /// <param name="percent">Percent amount of commission.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public PenaltyPercent(float? percent = default(float?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "PenaltyPercent", CommissionEnum? application = default(CommissionEnum?), Object extensionPoint = default(Object)) : base(type, application, extensionPoint)
        {
        ...
        {
            return this.Equals(input as PenaltyPercent);
        }

        /// <summary>
        /// Returns true if PenaltyPercent instances are equal
        /// </summary>
        /// <param name="input">Instance of PenaltyPercent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PenaltyPercent input)
        {
            if (input == null)
                return false;
