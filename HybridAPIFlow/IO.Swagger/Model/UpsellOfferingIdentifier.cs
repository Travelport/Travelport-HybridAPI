...
namespace IO.Swagger.Model
{
    ...
    public partial class UpsellOfferingIdentifier :  IEquatable<UpsellOfferingIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsellOfferingIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpsellOfferingIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsellOfferingIdentifier" /> class.
        /// </summary>
        ...
        public UpsellOfferingIdentifier(string type = default(string), string id = default(string), Identifier identifier = default(Identifier), string catalogProductOfferingRef = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for UpsellOfferingIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpsellOfferingIdentifier {\n");
        ...
        {
            return this.Equals(input as UpsellOfferingIdentifier);
        }

        /// <summary>
        /// Returns true if UpsellOfferingIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsellOfferingIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsellOfferingIdentifier input)
        {
            if (input == null)
                return false;
