...
namespace IO.Swagger.Model
{
    ...
    public partial class BrandIdentifier :  IEquatable<BrandIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BrandIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandIdentifier" /> class.
        /// </summary>
        ...
        public BrandIdentifier(string type = default(string), string id = default(string), string brandRef = default(string), Identifier identifier = default(Identifier))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BrandIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BrandIdentifier {\n");
        ...
        {
            return this.Equals(input as BrandIdentifier);
        }

        /// <summary>
        /// Returns true if BrandIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandIdentifier input)
        {
            if (input == null)
                return false;
