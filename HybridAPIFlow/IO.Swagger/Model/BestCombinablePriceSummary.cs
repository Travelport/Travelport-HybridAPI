...
{
    /// <summary>
    /// BestCombinablePriceSummary
    /// </summary>
    [DataContract]
    [JsonConverter(typeof(JsonSubtypes), "@type")]
    public partial class BestCombinablePriceSummary :  IEquatable<BestCombinablePriceSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BestCombinablePriceSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BestCombinablePriceSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BestCombinablePriceSummary" /> class.
        /// </summary>
        ...
        public BestCombinablePriceSummary(string type = default(string), string id = default(string), CurrencyCode currencyCode = default(CurrencyCode), float? _base = default(float?), float? totalTaxes = default(float?), float? totalFees = default(float?), float? totalPrice = default(float?), VendorCurrencyTotal vendorCurrencyTotal = default(VendorCurrencyTotal), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BestCombinablePriceSummary and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BestCombinablePriceSummary {\n");
        ...
        {
            return this.Equals(input as BestCombinablePriceSummary);
        }

        /// <summary>
        /// Returns true if BestCombinablePriceSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of BestCombinablePriceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BestCombinablePriceSummary input)
        {
            if (input == null)
                return false;
