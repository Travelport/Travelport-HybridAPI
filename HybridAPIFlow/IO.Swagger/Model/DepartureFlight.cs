...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DepartureFlight : DepartureFlightID,  IEquatable<DepartureFlight>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartureFlight" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepartureFlight() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartureFlight" /> class.
        /// </summary>
        ...
        public DepartureFlight(int? distance = default(int?), int? stops = default(int?), string duration = default(string), string carrier = default(string), string number = default(string), string operatingCarrier = default(string), string operatingCarrierName = default(string), string equipment = default(string), Departure departure = default(Departure), Arrival arrival = default(Arrival), List<IntermediateStop> intermediateStop = default(List<IntermediateStop>), bool? subjectToGovernmentApprovalInd = default(bool?), Object extensionPoint = default(Object), string type = "DepartureFlight", string id = default(string), string flightRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, flightRef, identifier)
        {
            // to ensure "carrier" is required (not null)
            if (carrier == null)
            {
                throw new InvalidDataException("carrier is a required property for DepartureFlight and cannot be null");
            }
            else
            {
            ...
            if (number == null)
            {
                throw new InvalidDataException("number is a required property for DepartureFlight and cannot be null");
            }
            else
            {
                this.Number = number;
            ...
            if (departure == null)
            {
                throw new InvalidDataException("departure is a required property for DepartureFlight and cannot be null");
            }
            else
            {
            ...
            if (arrival == null)
            {
                throw new InvalidDataException("arrival is a required property for DepartureFlight and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DepartureFlight {\n");
        ...
        {
            return this.Equals(input as DepartureFlight);
        }

        /// <summary>
        /// Returns true if DepartureFlight instances are equal
        /// </summary>
        /// <param name="input">Instance of DepartureFlight to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartureFlight input)
        {
            if (input == null)
                return false;
