...
namespace IO.Swagger.Model
{
    ...
    public partial class Result :  IEquatable<Result>, IValidatableObject
    {
        ...
        public Result(string type = default(string), ResultStatusEnum? status = default(ResultStatusEnum?), List<Error> error = default(List<Error>), List<Warning> warning = default(List<Warning>), Object extensionPoint = default(Object))
        {
