...
namespace IO.Swagger.Model
{
    ...
    public partial class ArrivalSummary :  IEquatable<ArrivalSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrivalSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ArrivalSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrivalSummary" /> class.
        /// </summary>
        ...
        public ArrivalSummary(string type = default(string), string location = default(string), DateTime? date = default(DateTime?), string time = default(string), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ArrivalSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for ArrivalSummary and cannot be null");
            }
            else
            {
            ...
            if (date == null)
            {
                throw new InvalidDataException("date is a required property for ArrivalSummary and cannot be null");
            }
            else
            {
                this.Date = date;
            ...
            if (time == null)
            {
                throw new InvalidDataException("time is a required property for ArrivalSummary and cannot be null");
            }
            else
            {
                this.Time = time;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ArrivalSummary {\n");
        ...
        {
            return this.Equals(input as ArrivalSummary);
        }

        /// <summary>
        /// Returns true if ArrivalSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ArrivalSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ArrivalSummary input)
        {
            if (input == null)
                return false;
