...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TermsAndConditionsFullSummary : TermsAndConditionsFullID,  IEquatable<TermsAndConditionsFullSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsFullSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermsAndConditionsFullSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsFullSummary" /> class.
        /// </summary>
        ...
        public TermsAndConditionsFullSummary(DateTime? expiryDate = default(DateTime?), List<CustomerLoyalty> customerLoyalty = default(List<CustomerLoyalty>), List<TravelerProduct> travelerProduct = default(List<TravelerProduct>), List<TextBlock> textBlock = default(List<TextBlock>), Object extensionPoint = default(Object), string type = "TermsAndConditionsFullSummary", string id = default(string), string termsAndConditionsRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, termsAndConditionsRef, identifier)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermsAndConditionsFullSummary {\n");
        ...
        {
            return this.Equals(input as TermsAndConditionsFullSummary);
        }

        /// <summary>
        /// Returns true if TermsAndConditionsFullSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsAndConditionsFullSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsAndConditionsFullSummary input)
        {
            if (input == null)
                return false;
