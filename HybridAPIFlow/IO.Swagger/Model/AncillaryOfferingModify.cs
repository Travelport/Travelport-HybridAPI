...
{
    /// <summary>
    /// AncillaryOfferingModify
    /// </summary>
    [DataContract]
    public partial class AncillaryOfferingModify : AncillaryOffering,  IEquatable<AncillaryOfferingModify>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AncillaryOfferingModify" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AncillaryOfferingModify() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AncillaryOfferingModify" /> class.
        /// </summary>
        ...
        public AncillaryOfferingModify(ModifyPrice modifyPrice = default(ModifyPrice), FlownStatus flownStatus = default(FlownStatus), ExtensionPointCustom extensionPointCustom = default(ExtensionPointCustom), string type = default(string), string id = default(string), string catalogOfferingRef = default(string), string ancillaryOfferingRef = default(string), Identifier identifier = default(Identifier), List<string> productRefs = default(List<string>), List<ProductOptionsID> productOptions = default(List<ProductOptionsID>), Price price = default(Price), TermsAndConditionsID termsAndConditions = default(TermsAndConditionsID), Object extensionPoint = default(Object)) : base(productRefs, productOptions, price, termsAndConditions, extensionPoint)
        {
            // to ensure "modifyPrice" is required (not null)
            if (modifyPrice == null)
            {
                throw new InvalidDataException("modifyPrice is a required property for AncillaryOfferingModify and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AncillaryOfferingModify {\n");
        ...
        {
            return this.Equals(input as AncillaryOfferingModify);
        }

        /// <summary>
        /// Returns true if AncillaryOfferingModify instances are equal
        /// </summary>
        /// <param name="input">Instance of AncillaryOfferingModify to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AncillaryOfferingModify input)
        {
            if (input == null)
                return false;
