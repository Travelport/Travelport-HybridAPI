...
namespace IO.Swagger.Model
{
    ...
    public partial class TotalAmount :  IEquatable<TotalAmount>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as TotalAmount);
        }

        /// <summary>
        /// Returns true if TotalAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of TotalAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TotalAmount input)
        {
            if (input == null)
                return false;
