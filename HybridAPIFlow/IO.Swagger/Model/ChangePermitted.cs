...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangePermitted : Change,  IEquatable<ChangePermitted>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangePermitted" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangePermitted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangePermitted" /> class.
        /// </summary>
        ...
        public ChangePermitted(List<PenaltyTypeEnum> penaltyTypes = default(List<PenaltyTypeEnum>), PenaltyAppliesToEnum penaltyAppliesTo = default(PenaltyAppliesToEnum), List<Penalty> penalty = default(List<Penalty>), bool? higherPenatltyAppliesInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "ChangePermitted", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
            // to ensure "penaltyTypes" is required (not null)
            if (penaltyTypes == null)
            {
                throw new InvalidDataException("penaltyTypes is a required property for ChangePermitted and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("penaltyAppliesTo is a required property for ChangePermitted and cannot be null");
            }
            else
            {
            ...
            if (penalty == null)
            {
                throw new InvalidDataException("penalty is a required property for ChangePermitted and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ChangePermitted);
        }

        /// <summary>
        /// Returns true if ChangePermitted instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangePermitted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangePermitted input)
        {
            if (input == null)
                return false;
