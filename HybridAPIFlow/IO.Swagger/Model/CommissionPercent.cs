...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommissionPercent : Commission,  IEquatable<CommissionPercent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommissionPercent" /> class.
        /// </summary>
        ...
        public CommissionPercent(float? percent = default(float?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "CommissionPercent", CommissionEnum? application = default(CommissionEnum?), Object extensionPoint = default(Object)) : base(type, application, extensionPoint)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommissionPercent {\n");
        ...
        {
            return this.Equals(input as CommissionPercent);
        }

        /// <summary>
        /// Returns true if CommissionPercent instances are equal
        /// </summary>
        /// <param name="input">Instance of CommissionPercent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommissionPercent input)
        {
            if (input == null)
                return false;
