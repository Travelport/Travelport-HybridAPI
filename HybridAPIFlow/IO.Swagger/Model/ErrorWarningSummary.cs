...
namespace IO.Swagger.Model
{
    ...
    public partial class ErrorWarningSummary :  IEquatable<ErrorWarningSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorWarningSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ErrorWarningSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorWarningSummary" /> class.
        /// </summary>
        ...
        public ErrorWarningSummary(string type = default(string), int? statusCode = default(int?), string message = default(string), List<NameValuePair> nameValuePair = default(List<NameValuePair>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ErrorWarningSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for ErrorWarningSummary and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorWarningSummary {\n");
        ...
        {
            return this.Equals(input as ErrorWarningSummary);
        }

        /// <summary>
        /// Returns true if ErrorWarningSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorWarningSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorWarningSummary input)
        {
            if (input == null)
                return false;
