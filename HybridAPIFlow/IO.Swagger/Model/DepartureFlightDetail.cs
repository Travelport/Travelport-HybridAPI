...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DepartureFlightDetail : DepartureFlightID,  IEquatable<DepartureFlightDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartureFlightDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DepartureFlightDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DepartureFlightDetail" /> class.
        /// </summary>
        ...
        public DepartureFlightDetail(AvailabilitySourceCodeENUM availabilitySourceCode = default(AvailabilitySourceCodeENUM), ExtensionPointDetail extensionPointDetail = default(ExtensionPointDetail), string type = "DepartureFlightDetail", string id = default(string), string flightRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, flightRef, identifier)
        {
        ...
        {
            return this.Equals(input as DepartureFlightDetail);
        }

        /// <summary>
        /// Returns true if DepartureFlightDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DepartureFlightDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepartureFlightDetail input)
        {
            if (input == null)
                return false;
