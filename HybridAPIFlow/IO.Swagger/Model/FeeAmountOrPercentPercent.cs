...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FeeAmountOrPercentPercent : FeeAmountOrPercent,  IEquatable<FeeAmountOrPercentPercent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeAmountOrPercentPercent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeeAmountOrPercentPercent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeeAmountOrPercentPercent" /> class.
        /// </summary>
        /// <param name="percent">Percent amount of commission.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public FeeAmountOrPercentPercent(float? percent = default(float?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "FeeAmountOrPercentPercent", CommissionEnum? application = default(CommissionEnum?), Object extensionPoint = default(Object)) : base(type, application, extensionPoint)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FeeAmountOrPercentPercent {\n");
        ...
        {
            return this.Equals(input as FeeAmountOrPercentPercent);
        }

        /// <summary>
        /// Returns true if FeeAmountOrPercentPercent instances are equal
        /// </summary>
        /// <param name="input">Instance of FeeAmountOrPercentPercent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeeAmountOrPercentPercent input)
        {
            if (input == null)
                return false;
