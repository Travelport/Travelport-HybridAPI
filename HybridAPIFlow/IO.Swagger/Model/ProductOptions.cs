...
namespace IO.Swagger.Model
{
    ...
    public partial class ProductOptions : ProductOptionsID,  IEquatable<ProductOptions>, IValidatableObject
    {
        ...
        public ProductOptions(int? sequence = default(int?), List<ProductID> product = default(List<ProductID>), Object extensionPoint = default(Object), string type = "ProductOptions", string id = default(string), Identifier identifier = default(Identifier), string productOptionsRef = default(string)) : base(type, id, identifier, productOptionsRef)
        {
