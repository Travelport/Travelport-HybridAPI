...
namespace IO.Swagger.Model
{
    ...
    public partial class AncillaryBrandTextDetail : AncillaryBrandText,  IEquatable<AncillaryBrandTextDetail>, IValidatableObject
    {
        ...
        public AncillaryBrandTextDetail(int? sequence = default(int?), string description = default(string), Image image = default(Image), string uRL = default(string), DateCreateModify dateCreateModify = default(DateCreateModify), ExtensionPointDetail extensionPointDetail = default(ExtensionPointDetail), string type = "AncillaryBrandTextDetail", string id = default(string), BrandTargetEnum? target = default(BrandTargetEnum?), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object)) : base(type, id, target, textFormatted, extensionPoint)
        {
