...
namespace IO.Swagger.Model
{
    ...
    public partial class ErrorWarning :  IEquatable<ErrorWarning>, IValidatableObject
    {
        ...
        public ErrorWarning(string type = default(string), int? statusCode = default(int?), string message = default(string), List<NameValuePair> nameValuePair = default(List<NameValuePair>), Object extensionPoint = default(Object))
        {
