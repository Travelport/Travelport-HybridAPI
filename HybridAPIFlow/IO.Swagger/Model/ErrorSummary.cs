...
namespace IO.Swagger.Model
{
    ...
    public partial class ErrorSummary :  IEquatable<ErrorSummary>, IValidatableObject
    {
        /// <summary>
        ...
        public ErrorSummary(string type = default(string), int? statusCode = default(int?), string message = default(string), List<NameValuePair> nameValuePair = default(List<NameValuePair>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ErrorSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for ErrorSummary and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ErrorSummary);
        }

        /// <summary>
        /// Returns true if ErrorSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorSummary input)
        {
            if (input == null)
                return false;
