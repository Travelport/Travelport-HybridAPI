...
namespace IO.Swagger.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(CatalogProductOffering), "CatalogProductOffering")]
    [JsonSubtypes.KnownSubType(typeof(CatalogProductOfferingSummary), "CatalogProductOfferingSummary")]
    public partial class CatalogProductOfferingID :  IEquatable<CatalogProductOfferingID>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOfferingID" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CatalogProductOfferingID() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogProductOfferingID" /> class.
        /// </summary>
        ...
        public CatalogProductOfferingID(string type = default(string), string id = default(string), Identifier identifier = default(Identifier), string catalogProductOfferingRef = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CatalogProductOfferingID and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as CatalogProductOfferingID);
        }

        /// <summary>
        /// Returns true if CatalogProductOfferingID instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogProductOfferingID to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogProductOfferingID input)
        {
            if (input == null)
                return false;
