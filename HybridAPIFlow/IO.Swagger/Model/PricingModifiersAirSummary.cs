...
namespace IO.Swagger.Model
{
    ...
    public partial class PricingModifiersAirSummary :  IEquatable<PricingModifiersAirSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModifiersAirSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PricingModifiersAirSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PricingModifiersAirSummary" /> class.
        /// </summary>
        ...
        public PricingModifiersAirSummary(string type = default(string), string currencyCode = default(string), FareSelection fareSelection = default(FareSelection), OrganizationInformation organizationInformation = default(OrganizationInformation), TaxExemption taxExemption = default(TaxExemption), List<PromotionalCode> promotionalCode = default(List<PromotionalCode>), string sellCity = default(string), string ticketCity = default(string), bool? includeSplitPaymentInd = default(bool?), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PricingModifiersAirSummary and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as PricingModifiersAirSummary);
        }

        /// <summary>
        /// Returns true if PricingModifiersAirSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PricingModifiersAirSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PricingModifiersAirSummary input)
        {
            if (input == null)
                return false;
