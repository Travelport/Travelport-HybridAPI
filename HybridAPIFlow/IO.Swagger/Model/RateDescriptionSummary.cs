...
namespace IO.Swagger.Model
{
    ...
    public partial class RateDescriptionSummary :  IEquatable<RateDescriptionSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RateDescriptionSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RateDescriptionSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RateDescriptionSummary" /> class.
        /// </summary>
        ...
        public RateDescriptionSummary(string type = default(string), string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RateDescriptionSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("textFormatted is a required property for RateDescriptionSummary and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RateDescriptionSummary {\n");
        ...
        {
            return this.Equals(input as RateDescriptionSummary);
        }

        /// <summary>
        /// Returns true if RateDescriptionSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of RateDescriptionSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RateDescriptionSummary input)
        {
            if (input == null)
                return false;
