...
namespace IO.Swagger.Model
{
    ...
    public partial class OfferIdentifier :  IEquatable<OfferIdentifier>, IValidatableObject
    {
        ...
        public OfferIdentifier(string type = default(string), string id = default(string), string offerRef = default(string), Identifier identifier = default(Identifier))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for OfferIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
