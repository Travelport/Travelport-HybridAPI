...
namespace IO.Swagger.Model
{
    ...
    public partial class DepartureArrival :  IEquatable<DepartureArrival>, IValidatableObject
    {
        ...
        public DepartureArrival(string type = default(string), string location = default(string), DateTime? date = default(DateTime?), string time = default(string), Object extensionPoint = default(Object))
        {
