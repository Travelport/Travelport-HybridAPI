...
namespace IO.Swagger.Model
{
    ...
    public partial class Departure :  IEquatable<Departure>, IValidatableObject
    {
        ...
        public Departure(string type = default(string), string location = default(string), DateTime? date = default(DateTime?), string time = default(string), Object extensionPoint = default(Object))
        {
