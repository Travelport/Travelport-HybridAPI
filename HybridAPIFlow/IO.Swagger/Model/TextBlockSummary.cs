...
namespace IO.Swagger.Model
{
    ...
    public partial class TextBlockSummary :  IEquatable<TextBlockSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TextBlockSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TextBlockSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TextBlockSummary" /> class.
        /// </summary>
        ...
        public TextBlockSummary(string type = default(string), string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TextBlockSummary and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("textFormatted is a required property for TextBlockSummary and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TextBlockSummary {\n");
        ...
        {
            return this.Equals(input as TextBlockSummary);
        }

        /// <summary>
        /// Returns true if TextBlockSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of TextBlockSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TextBlockSummary input)
        {
            if (input == null)
                return false;
