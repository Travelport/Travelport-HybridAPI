...
namespace IO.Swagger.Model
{
    ...
    public partial class CatalogOfferingIdentifier :  IEquatable<CatalogOfferingIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogOfferingIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CatalogOfferingIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogOfferingIdentifier" /> class.
        /// </summary>
        ...
        public CatalogOfferingIdentifier(string type = default(string), string id = default(string), string catalogOfferingRef = default(string), Identifier identifier = default(Identifier))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CatalogOfferingIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as CatalogOfferingIdentifier);
        }

        /// <summary>
        /// Returns true if CatalogOfferingIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogOfferingIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogOfferingIdentifier input)
        {
            if (input == null)
                return false;
