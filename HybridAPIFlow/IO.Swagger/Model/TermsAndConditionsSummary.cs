...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TermsAndConditionsSummary : TermsAndConditionsID,  IEquatable<TermsAndConditionsSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermsAndConditionsSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsSummary" /> class.
        /// </summary>
        ...
        public TermsAndConditionsSummary(DateTime? expiryDate = default(DateTime?), List<CustomerLoyalty> customerLoyalty = default(List<CustomerLoyalty>), List<TravelerProduct> travelerProduct = default(List<TravelerProduct>), Object extensionPoint = default(Object), string type = "TermsAndConditionsSummary", string id = default(string), string termsAndConditionsRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, termsAndConditionsRef, identifier)
        {
        ...
        {
            return this.Equals(input as TermsAndConditionsSummary);
        }

        /// <summary>
        /// Returns true if TermsAndConditionsSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsAndConditionsSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsAndConditionsSummary input)
        {
            if (input == null)
                return false;
