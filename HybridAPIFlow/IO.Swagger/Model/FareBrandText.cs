...
namespace IO.Swagger.Model
{
    ...
    public partial class FareBrandText :  IEquatable<FareBrandText>, IValidatableObject
    {
        ...
        public FareBrandText(string type = default(string), string id = default(string), BrandTargetEnum? target = default(BrandTargetEnum?), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
