...
namespace IO.Swagger.Model
{
    ...
    public partial class TermsAndConditionsSubCategoryDetail : TermsAndConditionsSubCategory,  IEquatable<TermsAndConditionsSubCategoryDetail>, IValidatableObject
    {
        ...
        public TermsAndConditionsSubCategoryDetail(int? sequence = default(int?), string description = default(string), Image image = default(Image), string uRL = default(string), DateCreateModify dateCreateModify = default(DateCreateModify), ExtensionPointDetail extensionPointDetail = default(ExtensionPointDetail), string type = "TermsAndConditionsSubCategoryDetail", string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object)) : base(type, title, id, textFormatted, extensionPoint)
        {
