...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdvancePaymentIndeterminate : AdvancePayment,  IEquatable<AdvancePaymentIndeterminate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancePaymentIndeterminate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AdvancePaymentIndeterminate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvancePaymentIndeterminate" /> class.
        /// </summary>
        /// <param name="indeterminateInd">If true the advance Payment restrictions could not be determined.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public AdvancePaymentIndeterminate(bool? indeterminateInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "AdvancePaymentIndeterminate", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
        ...
        /// </summary>
        /// <value>If true the advance Payment restrictions could not be determined</value>
        ...
        {
            return this.Equals(input as AdvancePaymentIndeterminate);
        }

        /// <summary>
        /// Returns true if AdvancePaymentIndeterminate instances are equal
        /// </summary>
        /// <param name="input">Instance of AdvancePaymentIndeterminate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdvancePaymentIndeterminate input)
        {
            if (input == null)
                return false;
