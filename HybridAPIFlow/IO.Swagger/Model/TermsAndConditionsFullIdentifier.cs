...
namespace IO.Swagger.Model
{
    ...
    public partial class TermsAndConditionsFullIdentifier :  IEquatable<TermsAndConditionsFullIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsFullIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermsAndConditionsFullIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsFullIdentifier" /> class.
        /// </summary>
        ...
        public TermsAndConditionsFullIdentifier(string type = default(string), string id = default(string), string termsAndConditionsRef = default(string), Identifier identifier = default(Identifier))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TermsAndConditionsFullIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermsAndConditionsFullIdentifier {\n");
        ...
        {
            return this.Equals(input as TermsAndConditionsFullIdentifier);
        }

        /// <summary>
        /// Returns true if TermsAndConditionsFullIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsAndConditionsFullIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsAndConditionsFullIdentifier input)
        {
            if (input == null)
                return false;
