...
namespace IO.Swagger.Model
{
    ...
    public partial class RateDescription :  IEquatable<RateDescription>, IValidatableObject
    {
        ...
        public RateDescription(string type = default(string), string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
