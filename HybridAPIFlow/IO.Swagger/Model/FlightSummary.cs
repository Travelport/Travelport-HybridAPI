...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FlightSummary : FlightID,  IEquatable<FlightSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FlightSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FlightSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FlightSummary" /> class.
        /// </summary>
        ...
        public FlightSummary(int? distance = default(int?), int? stops = default(int?), string duration = default(string), string carrier = default(string), string number = default(string), string operatingCarrier = default(string), string operatingCarrierName = default(string), string equipment = default(string), Departure departure = default(Departure), Arrival arrival = default(Arrival), List<IntermediateStop> intermediateStop = default(List<IntermediateStop>), bool? subjectToGovernmentApprovalInd = default(bool?), Object extensionPoint = default(Object), string type = "FlightSummary", string id = default(string), string flightRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, flightRef, identifier)
        {
            // to ensure "carrier" is required (not null)
            if (carrier == null)
            {
                throw new InvalidDataException("carrier is a required property for FlightSummary and cannot be null");
            }
            else
            {
            ...
            if (number == null)
            {
                throw new InvalidDataException("number is a required property for FlightSummary and cannot be null");
            }
            else
            {
                this.Number = number;
            ...
            if (departure == null)
            {
                throw new InvalidDataException("departure is a required property for FlightSummary and cannot be null");
            }
            else
            {
            ...
            if (arrival == null)
            {
                throw new InvalidDataException("arrival is a required property for FlightSummary and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as FlightSummary);
        }

        /// <summary>
        /// Returns true if FlightSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of FlightSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FlightSummary input)
        {
            if (input == null)
                return false;
