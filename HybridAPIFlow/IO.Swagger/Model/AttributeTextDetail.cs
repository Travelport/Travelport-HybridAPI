...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttributeTextDetail : AttributeText,  IEquatable<AttributeTextDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeTextDetail" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AttributeTextDetail() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeTextDetail" /> class.
        /// </summary>
        ...
        public AttributeTextDetail(int? sequence = default(int?), string description = default(string), Image image = default(Image), string uRL = default(string), DateCreateModify dateCreateModify = default(DateCreateModify), ExtensionPointDetail extensionPointDetail = default(ExtensionPointDetail), string type = "AttributeTextDetail", string id = default(string), BrandTargetEnum? target = default(BrandTargetEnum?), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object)) : base(type, id, target, textFormatted, extensionPoint)
        {
            // to ensure "dateCreateModify" is required (not null)
            if (dateCreateModify == null)
            {
                throw new InvalidDataException("dateCreateModify is a required property for AttributeTextDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributeTextDetail {\n");
        ...
        {
            return this.Equals(input as AttributeTextDetail);
        }

        /// <summary>
        /// Returns true if AttributeTextDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributeTextDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeTextDetail input)
        {
            if (input == null)
                return false;
