...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OfferSummary : OfferID,  IEquatable<OfferSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OfferSummary" /> class.
        /// </summary>
        ...
        public OfferSummary(string parentOfferRef = default(string), List<ProductID> product = default(List<ProductID>), Price price = default(Price), List<TermsAndConditionsFullID> termsAndConditionsFull = default(List<TermsAndConditionsFullID>), bool? passiveOfferInd = default(bool?), Object extensionPoint = default(Object), string type = "OfferSummary", string id = default(string), string offerRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, offerRef, identifier)
        {
            // to ensure "product" is required (not null)
            if (product == null)
            {
                throw new InvalidDataException("product is a required property for OfferSummary and cannot be null");
            }
            else
            {
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for OfferSummary and cannot be null");
            }
            else
            {
                this.Price = price;
            ...
            {
                throw new InvalidDataException("termsAndConditionsFull is a required property for OfferSummary and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OfferSummary);
        }

        /// <summary>
        /// Returns true if OfferSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of OfferSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OfferSummary input)
        {
            if (input == null)
                return false;
