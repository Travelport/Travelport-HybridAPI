...
namespace IO.Swagger.Model
{
    ...
    public partial class TermsAndConditionsIdentifier :  IEquatable<TermsAndConditionsIdentifier>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsIdentifier" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TermsAndConditionsIdentifier() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TermsAndConditionsIdentifier" /> class.
        /// </summary>
        ...
        public TermsAndConditionsIdentifier(string type = default(string), string id = default(string), string termsAndConditionsRef = default(string), Identifier identifier = default(Identifier))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TermsAndConditionsIdentifier and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TermsAndConditionsIdentifier {\n");
        ...
        {
            return this.Equals(input as TermsAndConditionsIdentifier);
        }

        /// <summary>
        /// Returns true if TermsAndConditionsIdentifier instances are equal
        /// </summary>
        /// <param name="input">Instance of TermsAndConditionsIdentifier to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TermsAndConditionsIdentifier input)
        {
            if (input == null)
                return false;
