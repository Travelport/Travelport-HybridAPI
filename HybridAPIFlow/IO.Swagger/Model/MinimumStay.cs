...
namespace IO.Swagger.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(MinimumStayApplies), "MinimumStayApplies")]
    [JsonSubtypes.KnownSubType(typeof(MinimumStayIndeterminate), "MinimumStayIndeterminate")]
    public partial class MinimumStay :  IEquatable<MinimumStay>, IValidatableObject
    {
        ...
        public MinimumStay(string type = default(string), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for MinimumStay and cannot be null");
            }
            else
            {
                this.Type = type;
