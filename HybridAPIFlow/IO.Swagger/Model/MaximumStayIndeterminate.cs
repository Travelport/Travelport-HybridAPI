...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MaximumStayIndeterminate : MaximumStay,  IEquatable<MaximumStayIndeterminate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MaximumStayIndeterminate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MaximumStayIndeterminate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MaximumStayIndeterminate" /> class.
        /// </summary>
        ...
        public MaximumStayIndeterminate(bool? indeterminateInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "MaximumStayIndeterminate", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MaximumStayIndeterminate {\n");
        ...
        {
            return this.Equals(input as MaximumStayIndeterminate);
        }

        /// <summary>
        /// Returns true if MaximumStayIndeterminate instances are equal
        /// </summary>
        /// <param name="input">Instance of MaximumStayIndeterminate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MaximumStayIndeterminate input)
        {
            if (input == null)
                return false;
