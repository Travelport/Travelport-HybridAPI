...
namespace IO.Swagger.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(BestCombinablePriceDetail), "BestCombinablePriceDetail")]
    public partial class BestCombinablePrice :  IEquatable<BestCombinablePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BestCombinablePrice" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BestCombinablePrice() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BestCombinablePrice" /> class.
        /// </summary>
        ...
        public BestCombinablePrice(string type = default(string), string id = default(string), CurrencyCode currencyCode = default(CurrencyCode), float? _base = default(float?), float? totalTaxes = default(float?), float? totalFees = default(float?), float? totalPrice = default(float?), VendorCurrencyTotal vendorCurrencyTotal = default(VendorCurrencyTotal), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BestCombinablePrice and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BestCombinablePrice {\n");
        ...
        {
            return this.Equals(input as BestCombinablePrice);
        }

        /// <summary>
        /// Returns true if BestCombinablePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of BestCombinablePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BestCombinablePrice input)
        {
            if (input == null)
                return false;
