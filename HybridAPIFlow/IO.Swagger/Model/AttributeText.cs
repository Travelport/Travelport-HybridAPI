...
namespace IO.Swagger.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(AttributeTextDetail), "AttributeTextDetail")]
    public partial class AttributeText :  IEquatable<AttributeText>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeText" /> class.
        /// </summary>
        ...
        public AttributeText(string type = default(string), string id = default(string), BrandTargetEnum? target = default(BrandTargetEnum?), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AttributeText and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("textFormatted is a required property for AttributeText and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AttributeText);
        }

        /// <summary>
        /// Returns true if AttributeText instances are equal
        /// </summary>
        /// <param name="input">Instance of AttributeText to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeText input)
        {
            if (input == null)
                return false;
