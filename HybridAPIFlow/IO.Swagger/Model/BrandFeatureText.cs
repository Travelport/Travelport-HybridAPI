...
namespace IO.Swagger.Model
{
    ...
    public partial class BrandFeatureText :  IEquatable<BrandFeatureText>, IValidatableObject
    {
        ...
        public BrandFeatureText(string type = default(string), string title = default(string), string id = default(string), List<TextFormatted> textFormatted = default(List<TextFormatted>), Object extensionPoint = default(Object))
        {
