...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AncillaryOffering : AncillaryOfferingID,  IEquatable<AncillaryOffering>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AncillaryOffering" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AncillaryOffering() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AncillaryOffering" /> class.
        /// </summary>
        ...
        public AncillaryOffering(List<string> productRefs = default(List<string>), List<ProductOptionsID> productOptions = default(List<ProductOptionsID>), Price price = default(Price), TermsAndConditionsID termsAndConditions = default(TermsAndConditionsID), Object extensionPoint = default(Object), string type = "AncillaryOffering", string id = default(string), string catalogOfferingRef = default(string), string ancillaryOfferingRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, catalogOfferingRef, ancillaryOfferingRef, identifier)
        {
            // to ensure "productOptions" is required (not null)
            if (productOptions == null)
            {
                throw new InvalidDataException("productOptions is a required property for AncillaryOffering and cannot be null");
            }
            else
            {
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for AncillaryOffering and cannot be null");
            }
            else
            {
                this.Price = price;
        ...
        {
            return this.Equals(input as AncillaryOffering);
        }

        /// <summary>
        /// Returns true if AncillaryOffering instances are equal
        /// </summary>
        /// <param name="input">Instance of AncillaryOffering to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AncillaryOffering input)
        {
            if (input == null)
                return false;
