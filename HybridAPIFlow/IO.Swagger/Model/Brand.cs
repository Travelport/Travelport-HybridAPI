...
namespace IO.Swagger.Model
{
    ...
    public partial class Brand : BrandID,  IEquatable<Brand>, IValidatableObject
    {
        ...
        public Brand(string name = default(string), int? tier = default(int?), List<int?> shelfNumbers = default(List<int?>), List<BrandAttribute> brandAttribute = default(List<BrandAttribute>), List<AdditionalBrandAttribute> additionalBrandAttribute = default(List<AdditionalBrandAttribute>), Object extensionPoint = default(Object), string type = "Brand", string id = default(string), string brandRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, brandRef, identifier)
        {
