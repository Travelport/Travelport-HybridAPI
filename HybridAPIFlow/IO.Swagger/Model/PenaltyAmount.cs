...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PenaltyAmount : Penalty,  IEquatable<PenaltyAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PenaltyAmount" /> class.
        /// </summary>
        ...
        public PenaltyAmount(CurrencyAmount amount = default(CurrencyAmount), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "PenaltyAmount", CommissionEnum? application = default(CommissionEnum?), Object extensionPoint = default(Object)) : base(type, application, extensionPoint)
        {
            this.Amount = amount;
        ...
        {
            return this.Equals(input as PenaltyAmount);
        }

        /// <summary>
        /// Returns true if PenaltyAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of PenaltyAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PenaltyAmount input)
        {
            if (input == null)
                return false;
