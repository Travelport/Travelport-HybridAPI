...
namespace IO.Swagger.Model
{
    ...
    public partial class CatalogOffering : CatalogOfferingID,  IEquatable<CatalogOffering>, IValidatableObject
    {
        ...
        public CatalogOffering(List<ProductOptionsID> productOptions = default(List<ProductOptionsID>), Price price = default(Price), TermsAndConditionsID termsAndConditions = default(TermsAndConditionsID), Object extensionPoint = default(Object), string type = "CatalogOffering", string id = default(string), string catalogOfferingRef = default(string), Identifier identifier = default(Identifier)) : base(type, id, catalogOfferingRef, identifier)
        {
