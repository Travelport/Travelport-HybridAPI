...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SeatAvailabilityOfferingsBuildFromCatalogProductOfferings : SeatAvailabilityOfferings,  IEquatable<SeatAvailabilityOfferingsBuildFromCatalogProductOfferings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeatAvailabilityOfferingsBuildFromCatalogProductOfferings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SeatAvailabilityOfferingsBuildFromCatalogProductOfferings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SeatAvailabilityOfferingsBuildFromCatalogProductOfferings" /> class.
        /// </summary>
        ...
        public SeatAvailabilityOfferingsBuildFromCatalogProductOfferings(BuildFromCatalogProductOfferingsRequest buildFromCatalogProductOfferingsRequest = default(BuildFromCatalogProductOfferingsRequest), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "SeatAvailabilityOfferingsBuildFromCatalogProductOfferings", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
            // to ensure "buildFromCatalogProductOfferingsRequest" is required (not null)
            if (buildFromCatalogProductOfferingsRequest == null)
            {
                throw new InvalidDataException("buildFromCatalogProductOfferingsRequest is a required property for SeatAvailabilityOfferingsBuildFromCatalogProductOfferings and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeatAvailabilityOfferingsBuildFromCatalogProductOfferings {\n");
        ...
        {
            return this.Equals(input as SeatAvailabilityOfferingsBuildFromCatalogProductOfferings);
        }

        /// <summary>
        /// Returns true if SeatAvailabilityOfferingsBuildFromCatalogProductOfferings instances are equal
        /// </summary>
        /// <param name="input">Instance of SeatAvailabilityOfferingsBuildFromCatalogProductOfferings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeatAvailabilityOfferingsBuildFromCatalogProductOfferings input)
        {
            if (input == null)
                return false;
