...
{
    /// <summary>
    /// SeatAvailabilityOfferingsBuildFromOffer
    /// </summary>
    [DataContract]
    public partial class SeatAvailabilityOfferingsBuildFromOffer : SeatAvailabilityOfferings,  IEquatable<SeatAvailabilityOfferingsBuildFromOffer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SeatAvailabilityOfferingsBuildFromOffer" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SeatAvailabilityOfferingsBuildFromOffer() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SeatAvailabilityOfferingsBuildFromOffer" /> class.
        /// </summary>
        ...
        public SeatAvailabilityOfferingsBuildFromOffer(BuildFromOffer buildFromOffer = default(BuildFromOffer), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "SeatAvailabilityOfferingsBuildFromOffer", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
            // to ensure "buildFromOffer" is required (not null)
            if (buildFromOffer == null)
            {
                throw new InvalidDataException("buildFromOffer is a required property for SeatAvailabilityOfferingsBuildFromOffer and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SeatAvailabilityOfferingsBuildFromOffer {\n");
        ...
        {
            return this.Equals(input as SeatAvailabilityOfferingsBuildFromOffer);
        }

        /// <summary>
        /// Returns true if SeatAvailabilityOfferingsBuildFromOffer instances are equal
        /// </summary>
        /// <param name="input">Instance of SeatAvailabilityOfferingsBuildFromOffer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SeatAvailabilityOfferingsBuildFromOffer input)
        {
            if (input == null)
                return false;
