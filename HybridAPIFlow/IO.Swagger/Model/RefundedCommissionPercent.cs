...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RefundedCommissionPercent : RefundedCommission,  IEquatable<RefundedCommissionPercent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundedCommissionPercent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RefundedCommissionPercent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundedCommissionPercent" /> class.
        /// </summary>
        /// <param name="percent">Percent amount of commission.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public RefundedCommissionPercent(float? percent = default(float?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "RefundedCommissionPercent", CommissionEnum? application = default(CommissionEnum?), Object extensionPoint = default(Object)) : base(type, application, extensionPoint)
        {
        ...
        {
            return this.Equals(input as RefundedCommissionPercent);
        }

        /// <summary>
        /// Returns true if RefundedCommissionPercent instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundedCommissionPercent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundedCommissionPercent input)
        {
            if (input == null)
                return false;
