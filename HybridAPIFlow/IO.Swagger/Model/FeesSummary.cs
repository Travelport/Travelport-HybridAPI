...
namespace IO.Swagger.Model
{
    ...
    public partial class FeesSummary :  IEquatable<FeesSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FeesSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FeesSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FeesSummary" /> class.
        /// </summary>
        ...
        public FeesSummary(string type = default(string), float? totalFees = default(float?), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for FeesSummary and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        {
            return this.Equals(input as FeesSummary);
        }

        /// <summary>
        /// Returns true if FeesSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of FeesSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FeesSummary input)
        {
            if (input == null)
                return false;
