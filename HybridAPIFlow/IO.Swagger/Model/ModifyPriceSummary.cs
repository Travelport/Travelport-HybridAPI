...
namespace IO.Swagger.Model
{
    ...
    public partial class ModifyPriceSummary :  IEquatable<ModifyPriceSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyPriceSummary" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifyPriceSummary() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyPriceSummary" /> class.
        /// </summary>
        ...
        public ModifyPriceSummary(string type = default(string), string id = default(string), CurrencyCode currencyCode = default(CurrencyCode), float? _base = default(float?), float? totalTaxes = default(float?), float? totalFees = default(float?), float? totalPrice = default(float?), VendorCurrencyTotal vendorCurrencyTotal = default(VendorCurrencyTotal), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ModifyPriceSummary and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyPriceSummary {\n");
        ...
        {
            return this.Equals(input as ModifyPriceSummary);
        }

        /// <summary>
        /// Returns true if ModifyPriceSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyPriceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyPriceSummary input)
        {
            if (input == null)
                return false;
