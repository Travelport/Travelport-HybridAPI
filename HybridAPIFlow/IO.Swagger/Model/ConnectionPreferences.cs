...
namespace IO.Swagger.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(ConnectionPreferencesAir), "ConnectionPreferencesAir")]
    public partial class ConnectionPreferences :  IEquatable<ConnectionPreferences>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionPreferences" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConnectionPreferences() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionPreferences" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="legSequence">Assigned Type: c-1100:SegmentSequenceList.</param>
        /// <param name="maxConnectionDuration">The maximum acceptable duration of the connection.</param>
        /// <param name="maxOvernightDuration">The maximum acceptable overnight duration of the connection.</param>
        /// <param name="connectionPoint">connectionPoint.</param>
        /// <param name="extensionPoint">extensionPoint.</param>
        public ConnectionPreferences(string type = default(string), List<int?> legSequence = default(List<int?>), string maxConnectionDuration = default(string), string maxOvernightDuration = default(string), List<string> connectionPoint = default(List<string>), Object extensionPoint = default(Object))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ConnectionPreferences and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// </summary>
        /// <value>The maximum acceptable duration of the connection</value>
        ...
        /// </summary>
        /// <value>The maximum acceptable overnight duration of the connection</value>
        ...
        public List<string> ConnectionPoint { get; set; }
        ...
        {
            return this.Equals(input as ConnectionPreferences);
        }

        /// <summary>
        /// Returns true if ConnectionPreferences instances are equal
        /// </summary>
        /// <param name="input">Instance of ConnectionPreferences to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConnectionPreferences input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ConnectionPoint == input.ConnectionPoint ||
                    this.ConnectionPoint != null &&
                    this.ConnectionPoint.SequenceEqual(input.ConnectionPoint)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ConnectionPoint != null)
                    hashCode = hashCode * 59 + this.ConnectionPoint.GetHashCode();
