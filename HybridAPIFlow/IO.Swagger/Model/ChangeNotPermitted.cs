...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ChangeNotPermitted : Change,  IEquatable<ChangeNotPermitted>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeNotPermitted" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ChangeNotPermitted() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ChangeNotPermitted" /> class.
        /// </summary>
        /// <param name="notPermittedInd">Changes are not permitted.</param>
        /// <param name="extensionPointChoice">extensionPointChoice.</param>
        public ChangeNotPermitted(bool? notPermittedInd = default(bool?), ExtensionPointChoice extensionPointChoice = default(ExtensionPointChoice), string type = "ChangeNotPermitted", Object extensionPoint = default(Object)) : base(type, extensionPoint)
        {
        ...
        {
            return this.Equals(input as ChangeNotPermitted);
        }

        /// <summary>
        /// Returns true if ChangeNotPermitted instances are equal
        /// </summary>
        /// <param name="input">Instance of ChangeNotPermitted to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChangeNotPermitted input)
        {
            if (input == null)
                return false;
